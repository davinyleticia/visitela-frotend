  ...
  <div className="w-full max-w-200 p-6">
    <div className=" p-6 rounded-xl shadow border bg-white">
      <div className="flex justify-end items-start mb-4">
        <button className="text-2xl font-bold"><QrCode /></button>
      </div>
      ...
      <Text>
        Lorem ipsum dolor sit amet consectetur. Eu sed vitae nisi sollicitudin
        sit massa adipiscing. Ut volutpat molestie sed egestas penatibus enim.
      </Text>
      <ProfileActions />
